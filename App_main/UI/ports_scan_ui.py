...
class Ui_mw_main(object):
    def setupUi(self, mw_main):
        ...
        self.pb_scan.setGeometry(QtCore.QRect(180, 180, 111, 31))
        ...
        self.pb_cancel.setGeometry(QtCore.QRect(450, 490, 111, 31))
        self.pb_cancel.setObjectName("pb_cancel")
        self.lb_message = QtWidgets.QLabel(parent=self.centralwidget)
        self.lb_message.setGeometry(QtCore.QRect(20, 530, 591, 31))
        ...
        self.pb_stop_scan = QtWidgets.QPushButton(parent=self.centralwidget)
        self.pb_stop_scan.setGeometry(QtCore.QRect(310, 180, 111, 31))
        self.pb_stop_scan.setObjectName("pb_stop_scan")
        self.pushButton = QtWidgets.QPushButton(parent=self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(440, 180, 121, 31))
    ...
    def retranslateUi(self, mw_main):
        ...
        self.pb_stop_scan.setText(_translate("mw_main", "Stop Scan"))
        self.pushButton.setText(_translate("mw_main", "Clean entries"))
